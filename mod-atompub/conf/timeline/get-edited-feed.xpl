...
",
   element atom:id {
      concat($request-host,$app.path,"/timeline/updated/")
   },
   "
",
   element atom:link {
...
",
   ...
   if ((collection('app://collections/entry')/atom:entry)[position()&gt;=$ilimit])
   then ("
",
      element atom:link {
         attribute rel { "next" },
...
",
   element atom:updated {
      string((for $e in collection('app://collections/entry')/atom:entry
         order by $e/app:edited descending return $e)[1]/app:edited)
   },
   "
",
   for $e in (for $e in collection('app://collections/entry')/atom:entry order by $e/app:edited descending return $e)[position()&gt;=$istart and position()&lt;$ilimit]
