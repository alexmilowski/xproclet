...
",
   element atom:id {
      concat($request-host,$app.path,"/timeline/published/")
   },
   "
",
   element atom:link {
...
",
   ...
   "
",
   (for $e in collection('app://collections/entry')/atom:entry
      order by $e/atom:updated descending return $e)[1]/atom:updated,
   "
",
   for $e in (for $e in collection('app://collections/entry')/atom:entry order by $e/atom:published descending return $e)[position()&gt;=$istart and position()&lt;$ilimit]
